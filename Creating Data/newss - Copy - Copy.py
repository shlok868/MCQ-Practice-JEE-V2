...
class PDFSlicerApp:
    ...
    def _create_control_widgets(self):
        ...
        # Split in 2 halves toggle
        self.split_halves_switch = ctk.CTkSwitch(self.top_frame, text="Split pages in 2 halves", command=self._toggle_split_halves, onvalue=True, offvalue=False)
        self.split_halves_switch.grid(row=2, column=5, padx=20, pady=5)
        self.split_halves_switch.select()  # ON by default
        self.split_in_halves = True
